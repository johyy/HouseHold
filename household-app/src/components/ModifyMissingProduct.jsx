  ...
  return (
    <View>
      <Pressable onPress={() => setShowPicker(true)}>
        <TextInput
          style={styles.modifyProductInput}
...
const ModifyMissingProduct = () => {
    ...
    try {
      ...
      const updatedProduct = {
        ...
        expiration_date: product.expiration_date
          ? new Date(product.expiration_date).toISOString()
          : null,
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <View style={styles.modifyProductPicker}>
        <Picker
      ...
      <Pressable style={styles.modifyProductButton} onPress={handleSubmit}>
        <Text style={styles.buttonText}>Tallenna muutokset</Text>
      </Pressable>
      <Pressable
        style={styles.modifyProductButton}
        onPress={() => navigate(`/productmissing/${id}`)}
      >
