    ...
    <View style={styles.mainContainer}>
      ...
      <Routes>
        <Route
          path="/"
          element={
            isSignedIn ? <ProductList /> : <Navigate to="/signin" replace />
          }
        />
        <Route
          path="/signin"
        ...
        <Route
          path="/product/:id"
          element={
            isSignedIn ? <ProductDetails /> : <Navigate to="/singin" replace />
          }
        />
        <Route
          path="/addproduct"
          element={
            isSignedIn ? <AddProduct /> : <Navigate to="/singin" replace />
          }
        />
        <Route
          path="/addlocation"
          element={
            isSignedIn ? <AddLocation /> : <Navigate to="/signin" replace />
          }
        />
        <Route
          path="/addcategory"
          element={
            isSignedIn ? <AddCategory /> : <Navigate to="/signin" replace />
          }
        />
        <Route
          path="/modifyproduct/:id"
          element={
            isSignedIn ? <ModifyProduct /> : <Navigate to="/singin" replace />
          }
        />
        <Route
          path="/userpreferences"
          element={
            isSignedIn ? <UserPreferences /> : <Navigate to="/singin" replace />
          }
        />
        <Route
          path="/missingproducts"
          element={
            isSignedIn ? <MissingProducts /> : <Navigate to="/singin" replace />
          }
        />
        <Route
          path="/settings"
          element={
            isSignedIn ? <Settings /> : <Navigate to="/singin" replace />
          }
        />
        <Route
        ...
        <Route
          path="/addpreferences"
          element={
            isSignedIn ? <AddPreferences /> : <Navigate to="/singin" replace />
          }
        />
        <Route
